...
const mockBus = {
  ...
  occupancy: 25,
  maxCapacity: 40,
  currentStop: 'GUB Permanent Campus',
  nextStop: 'Kuril BiswaRoad',
  eta: '34 mins'
};
      ...
      <div className="relative bg-indigo-600 h-[40vh]">
        ...
        <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">
            BUSKOI: A Real Time Bus Tracker
          </h1>
          <p className="mt-6 text-xl text-indigo-100 max-w-3xl">
            Track your bus in real-time, check routes, and receive notifications when your bus is nearby.
          </p>
        </div>
      </div>
      ...
      <footer className="bg-gray-800 mt-12">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 pt-8 border-t border-gray-700">
            <p className="text-gray-400 text-center">© 2024 BUSKOI. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
